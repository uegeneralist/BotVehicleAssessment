...
#include "BotVehicleAssessmentPlayerController.generated.h"

class UInputMappingContext;
class ABotVehicleAssessmentPawn;
class UBotVehicleAssessmentUI;
...
class ABotVehicleAssessmentPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<ABotVehicleAssessmentPawn> VehiclePawnClass;

	/** Pointer to the controlled vehicle pawn */
	TObjectPtr<ABotVehicleAssessmentPawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, Category="Vehicle|UI")
	TSubclassOf<UBotVehicleAssessmentUI> VehicleUIClass;

	/** Pointer to the UI widget */
	UPROPERTY()
	TObjectPtr<UBotVehicleAssessmentUI> VehicleUI;
