...
#include "BotVehicleAssessmentSportsCar.h"
#include "BotVehicleAssessmentSportsWheelFront.h"
#include "BotVehicleAssessmentSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ABotVehicleAssessmentSportsCar::ABotVehicleAssessmentSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UBotVehicleAssessmentSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UBotVehicleAssessmentSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UBotVehicleAssessmentSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UBotVehicleAssessmentSportsWheelRear::StaticClass();
