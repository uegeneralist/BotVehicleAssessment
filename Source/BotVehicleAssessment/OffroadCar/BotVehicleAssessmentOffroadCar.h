...
#include "BotVehicleAssessmentOffroadCar.generated.h"

/**
 *  Offroad car wheeled vehicle implementation
 */
UCLASS(abstract)
class ABotVehicleAssessmentOffroadCar : public ABotVehicleAssessmentPawn
{
	GENERATED_BODY()
...
public:
	...
	ABotVehicleAssessmentOffroadCar();
};
