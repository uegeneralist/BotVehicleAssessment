...
#include "BotVehicleAssessmentOffroadCar.h"
#include "BotVehicleAssessmentOffroadWheelFront.h"
#include "BotVehicleAssessmentOffroadWheelRear.h"
...
ABotVehicleAssessmentOffroadCar::ABotVehicleAssessmentOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UBotVehicleAssessmentOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UBotVehicleAssessmentOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UBotVehicleAssessmentOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UBotVehicleAssessmentOffroadWheelRear::StaticClass();
